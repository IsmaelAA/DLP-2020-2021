...
//	class For { Definition variable;  Expression condition;  Sentence step;  List<Sentence> sentence; }
    public Object visit(For node, Object param) {
	
	if (node.getSentencia() != null)
	    node.getSentencia().accept(this, param);
	...
	if (node.getStep() != null)
	    node.getStep().accept(this, param);
